...
public class PojoRiskTradeLog implements java.io.Serializable {
    ...
    public PojoRiskTradeLog() {
    }

    public PojoRiskTradeLog(long tid) {
        this.tid = tid;
    }
    public PojoRiskTradeLog(long tid, Integer riskTradeType, String txnseqno,
